...
function Connect4(p1, p2, gameId) {
    ...
    var handleColumnClick = function(self) {
        ...
        return function(e) {
            if (playerCheck == self.currentPlayer().name){
    ...
    this.titleWin = function() {
        if (this.gameOver) {
            ...
            var winText2 = "";
            if (this.p1.winner) {
                winText2 = ": " + this.p1.name + " Wins!";
                //winText = winText + ": " + this.p1.name + " Wins!";
            } else {
                winText2 = ": " + this.p2.name + " Wins!";
                //winText = winText + ": " + this.p2.name + " Wins!";
            }

            document.getElementById('title').textContent = p1.name + " vs " + p2.name + winText2;
        }
    }
